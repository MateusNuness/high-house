...
>
> Este documento antecede o Design System.
>
> Seu objetivo não é definir componentes.
>
> Seu objetivo é definir a linguagem visual permanente da High House.

---

# 1. Propósito

Toda marca consistente possui um DNA visual.

Esse DNA existe antes das cores.
...
O objetivo deste documento é registrar esse DNA de forma explícita para que qualquer decisão estética futura permaneça coerente.

Este documento responde à pergunta:

> "Como a High House deve parecer?"

Ele não responde:

> "Como implementar essa aparência?"

Essa responsabilidade pertence ao Design System.

---

# 2. Filosofia

A High House não deseja parecer moderna.

Também não deseja parecer retrô.
...
O design não existe para decorar.

O design existe para comunicar.
...
# 4. O Design como Sistema

O design da High House não é composto por peças independentes.
...
# 8. O que a High House Nunca Deve Parecer

Este capítulo possui prioridade absoluta.
